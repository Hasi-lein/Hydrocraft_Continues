...
farming_vegetableconf.icons["Sweetpotato"] = "media/textures/Item_HCSweetpotato.png";
...
-- Sweetpotato (16 to 20 weeks to grow)
farming_vegetableconf.props["Sweetpotato"] = {};
farming_vegetableconf.props["Sweetpotato"].seedsRequired = 4;
farming_vegetableconf.props["Sweetpotato"].texture = "vegetation_farming_01_46";
farming_vegetableconf.props["Sweetpotato"].waterLvl = 65;
farming_vegetableconf.props["Sweetpotato"].waterLvlMax = 100;
farming_vegetableconf.props["Sweetpotato"].timeToGrow = ZombRand(89, 103);
farming_vegetableconf.props["Sweetpotato"].minVeg = 3;
farming_vegetableconf.props["Sweetpotato"].maxVeg = 4;
farming_vegetableconf.props["Sweetpotato"].minVegAutorized = 5;
farming_vegetableconf.props["Sweetpotato"].maxVegAutorized = 9;
farming_vegetableconf.props["Sweetpotato"].vegetableName = "Hydrocraft.HCSweetpotato";
farming_vegetableconf.props["Sweetpotato"].seedName = "Hydrocraft.HCPotatosweetseeds";
farming_vegetableconf.props["Sweetpotato"].seedCollect = 0;
farming_vegetableconf.props["Sweetpotato"].seedPerVeg = 5;
farming_vegetableconf.props["Sweetpotato"].minTemp = 5;
farming_vegetableconf.props["Sweetpotato"].bestTemp = 20;
farming_vegetableconf.props["Sweetpotato"].maxTemp = 30;
farming_vegetableconf.props["Sweetpotato"].plantWithFruit = true;
farming_vegetableconf.props["Sweetpotato"].damageFromStorm = false;
farming_vegetableconf.props["Sweetpotato"].multiHarvest = false;
farming_vegetableconf.props["Sweetpotato"].vegetableName2 = "";
farming_vegetableconf.props["Sweetpotato"].numberOfVegetables2 = 0;
...
farming_vegetableconf.props["Wheat"].maxVeg = 5;
...
farming_vegetableconf.sprite["Sweetpotato"] = farming_vegetableconf.sprite["Potatoes"]
